...
**Ajeya Cotra:**
I have wide error bars in the report on using the scaling from [the Kaplan et al 2020 paper](https://arxiv.org/abs/2001.08361) as roughly a central estimate, but having a wide spread on how it would turn out with different architectures, different types of data, and future models. I think it's been going about as well as you might've hoped in terms of reliability, but it's only been a year and it's only been tried out in a few places.
